    ...
    <div class="panel panel-primary">
        ...
        <div id="div1" class="panel-collapse in">
            <div class="list-group">
                ...
                <a href="${pageContext.request.contextPath}/epidemic.jsp" class="list-group-item">数据查询</a>
                <a href="#" class="list-group-item">图表展示</a>
            </div>
        </div>
    </div>
    <div class="panel panel-primary">
        ...
        <div id="div2" class="panel-collapse in">
            <div class="list-group">
                <a href="#" class="list-group-item">用户录入</a>
